...
import { testimonials } from "./wholesaleConstants";

export function WholesaleTestimonialsSection() {
  return (
    <section className="py-20">
      <div className="text-center mb-16">
        <h2 className="text-4xl serif mb-6">What Our Partners Say</h2>
        <p className="text-xl text-white/80 max-w-3xl mx-auto">
          Hear from restaurant owners and chefs who have elevated their menus with our premium American Wagyu.
        </p>
      </div>
